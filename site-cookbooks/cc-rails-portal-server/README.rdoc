...
= Moving production resource page attachements to AWS:
  ...
  Then after doing that you'll need to make all the files have public access. There is an option in the AWS UI for this called "make public" in the actions on a folder.
  Normally paperclip makes them public as it uploads them to s3.
